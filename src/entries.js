...
const ENTRIES = [
  {
    "id": "ebr", 
    "date": "2026-01-12", 
    "title": "Announcing Emerald Battle Revolution!", 
    "tags": ["ebr"], 
    "content": `
[h]{Introduction}
[p]{
Hey everyone! Today, I'm excited to announce what has been a long-term project for me over the past few years - Emerald Battle Revolution!
This is a Pokemon Emerald romhack which is focused around making the Battle Frontier as accessible as possible, and allows players to 
build fully competitive teams, customise battle rules, and more!
}
[p]{
This project is based on [link]{pokeemerald-expansion,https://github.com/rh-hideout/pokeemerald-expansion} and has support for all moves, 
...
[b]{Legendary Shop, for purchasing Legendary or Mythical Pokemon (And their related items)}
[b]{Pokemon Day Care, with a Pokemon Breeder selling every non-legendary/mythical first evolution Pokemon (and their evolution items)}
Bi-Directional currency converters, for exchanging between Battle Points and money
Pokemon Chemist (Nature Mints, EV-training items, etc.)
Training Shop (Tera Shards, mochi, etc.)
Pokemon Center
Training Berry Shop (IV.EV lowering, etc.)
Game Corner, including bi-directional currency converters
Mega Stone / Z-Crystal Shop
General Battle Item Shop
Type Gem / Type Item Shop (Fire Gem, Charcoal, etc.)
Battle Berry Shop (e.g. Sitrus Berry, Coba Berry, etc.)
TM Shop
[b]{Sample Sets / Sample Teams Shop, where you can purchase full pre-made teams / Pokemon}
...
Apply the patch using a rom patcher (recommended: [link]{RomPatcher.js,https://www.marcrobledo.com/RomPatcher.js/})
Download a GBA emulator (recommended: [link]{mGBA,https://mgba.io/downloads.html})
Enjoy!
}
[h]{Resources}
[ul]{
